...
const props = defineProps<{ selectedTemplate: { name: string, headline: string, greeting: string, content: string } | null }>();
...
<template>
  <form @submit.prevent="addTemplate">
    <div>
      ...
      <input v-model="inputName" type="text" id="name" class="formTemplate" placeholder="Geben Sie einen Namen für die Vorlage ...">
    </div>
    <div>
      <label for="betreff1" class="template-label">Betreff</label><br>
      <input v-model="inputHeading" type="text" class="formTemplate" placeholder="Geben Sie einen Betreff für die Vorlage ..." id="betreff">
    </div>
    <div>
